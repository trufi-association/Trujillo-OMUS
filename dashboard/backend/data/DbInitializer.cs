...
public static class DbInitializer
{
    ...
    private static void SeedCategories(OMUSContext context)
    {
        ...
        var categories = new Category[]
        {
            ...
            new Category { Id = 7, ParentId = null, CategoryName = "Huecos, algo malo en las pistas, veredas u otra afectación a la infraestructura.", hasVictim = false, hasDateTime = true },
            new Category { Id = 10, ParentId = null, CategoryName = "Algo anda mal con las pistas, veredas, ciclovías, etc.", hasVictim = false, hasDateTime = true},
            new Category { Id = 13, ParentId = null, CategoryName = "Otro actor maltrata o acosa", hasVictim = true, hasDateTime = true },
            new Category { Id = 14, ParentId = null, CategoryName = "Quiero reportar una infracción que cometió un conductor, peatón o ciclista", hasVictim = true, hasDateTime = true },
            ...
            new Category { Id = 16, ParentId = 4, CategoryName = "Robaron un carro", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 9, ParentId = 7, CategoryName = "Hay una calle/vereda o ciclovía que no conecta con nada", hasVictim = false, hasDateTime = true },
            new Category { Id = 27, ParentId = 7, CategoryName = "Falta de señalización", hasVictim = false, hasDateTime = true },
            new Category { Id = 28, ParentId = 7, CategoryName = "No hay vereda o espacio suficiente para caminar", hasVictim = false, hasDateTime = true },
            new Category { Id = 29, ParentId = 7, CategoryName = "Hay un obstáculo en la pista", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 12, ParentId = 10, CategoryName = "El bus/combi no pasa a tiempo", hasVictim = false, hasDateTime = true },
            new Category { Id = 31, ParentId = 10, CategoryName = "Semáforo con tiempo de verde muy corto", hasVictim = false, hasDateTime = true },
            new Category { Id = 32, ParentId = 10, CategoryName = "Daño en el paradero de bus micros o combis", hasVictim = false, hasDateTime = true },
            new Category { Id = 33, ParentId = 10, CategoryName = "Hay un bus/combi en malas condiciones o dañado", hasVictim = false, hasDateTime = true },
            new Category { Id = 50, ParentId = 10, CategoryName = "Información de rutas inexistente o robada", hasVictim = false, hasDateTime = true },
            new Category { Id = 51, ParentId = 10, CategoryName = "La ruta del bus/combi se desvió o no realizó el recorrido acostumbrado", hasVictim = false, hasDateTime = true },
            new Category { Id = 34, ParentId = 10, CategoryName = "Tuve que caminar más de 10 minutos para encontrar un paradero", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 21, ParentId = 14, CategoryName = "Alguien no respetó el semáforo en rojo", hasVictim = false, hasDateTime = true },
            new Category { Id = 22, ParentId = 14, CategoryName = "(e) respetando la luz roja del semáforo)", hasVictim = false, hasDateTime = true },
            new Category { Id = 23, ParentId = 14, CategoryName = "Un vehículo pisó el cruce peatonal", hasVictim = false, hasDateTime = true },
            new Category { Id = 35, ParentId = 14, CategoryName = "Motocicleta invade cicloinfraestructura", hasVictim = false, hasDateTime = true },
            new Category { Id = 36, ParentId = 14, CategoryName = "Un vehículo está obstruyendo el paso o está estacionado en una zona prohibida", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 40, ParentId = 38, CategoryName = "Quiero que haya un paradero de bicicletas compartidas", hasVictim = false, hasDateTime = false },
            new Category { Id = 41, ParentId = 38, CategoryName = "Pedir una estación de mecánica", hasVictim = false, hasDateTime = false },
            new Category { Id = 42, ParentId = 38, CategoryName = "Quiero que instalen un estacionamiento para bicicletas", hasVictim = false, hasDateTime = false },
            ...
            new Category { Id = 47, ParentId = 38, CategoryName = "Quiero que pongan un estacionamiento pagado en pista", hasVictim = false, hasDateTime = false },
            new Category { Id = 53, ParentId = 48, CategoryName = "Pusieron ciclovía", hasVictim = false, hasDateTime = false },
            new Category { Id = 54, ParentId = 48, CategoryName = "Arreglaron / instalaron vereda", hasVictim = false, hasDateTime = false },    new Category { Id = 56, ParentId = 13, CategoryName = "Me maltrataron verbalmente (o a alguien más) en el transporte público", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 62, ParentId = 10, CategoryName = "Patineta o bici compartida mal parqueada/bloqueando vereda, o no en paradero", hasVictim = false, hasDateTime = true },
            ...
            new Category { Id = 70, ParentId = 57, CategoryName = "Me agredieron por mi expresión de género u orientación sexual", hasVictim = true, hasDateTime = true },
            new Category { Id = 71, ParentId = null, CategoryName = "Me siento insegura(o) en este lugar", hasVictim = false, hasDateTime = true },
            new Category { Id = 72, ParentId = 7, CategoryName = "No hay rampas adecuadas para circular en silla de ruedas", hasVictim = false, hasDateTime = true },
            new Category { Id = 73, ParentId = 7, CategoryName = "Falta señalización táctil o de piso para personas con discapacidad visual", hasVictim = false, hasDateTime = true },
            new Category { Id = 74, ParentId = 13, CategoryName = "No me recogieron por ser estudiante", hasVictim = true, hasDateTime = true },
            new Category { Id = 75, ParentId = 13, CategoryName = "No me recogieron por tener una discapacidad", hasVictim = true, hasDateTime = true },
            new Category { Id = 76, ParentId = 13, CategoryName = "No me recogieron por ser adulto mayor", hasVictim = true, hasDateTime = true },
    };
